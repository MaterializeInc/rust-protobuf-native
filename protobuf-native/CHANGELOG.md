...
* Add `VirtualSourceTree::map_well_known_types` with the same functionality for
  virtual source trees.

* Embed well-known proto files at compile time for portability.

* Upgrade to protobuf-src v2.1.1+27.1.
